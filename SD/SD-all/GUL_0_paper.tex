...
\midrule
1 & $\mathcal{Q}(0)\neq 0$: nothing is unstable          & Axiom 1 \\
2 & $\mathcal{R}(x)=1/(1+x)$ is unique                   & Theorem 1 \\
3 & Three distinctions: this / not-this / other           & Theorem 3 \\
4 & $\phi$ is co-incidence of $\mathcal{R}$ and $\mathcal{Q}$ & Theorem 4 \\
5 & Pentac topology $T^3\times S^2$ from three distinctions & Corollary 2 \\
6 & $G_{\mathrm{SM}}=\mathrm{SU}(3)\times\mathrm{SU}(2)\times\mathrm{U}(1)$ & GUL \S7 \\
7 & Fermion masses from $\mathcal{R}$-depth hierarchy     & GUL \S10 + v2.8 \\
8 & Questioner at $d=\infty$: $\mathcal{Q}(\phi)=\phi$   & Theorem 6 \\
\bottomrule
\end{tabular}
\end{table}
